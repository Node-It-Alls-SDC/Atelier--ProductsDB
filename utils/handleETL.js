...
const { transformProduct, transformFeatures, transformRelated, transformSkus, transformStyles, transformCart } = require('./transformers.js');
const { loadProduct, loadFeatures, loadRelated, loadSkus, loadStyles, loadCart } = require('./load.js');
...
// EXTRACT
    ...
    console.log('Loading Skus into DB...');
